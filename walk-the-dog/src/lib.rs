...
pub fn main_js() -> Result<(), JsValue> {
    // 全てのRustのパニックがブラウザのコンソールにリダイレクトされる
    ...
    sierpinski(&context, [(300.0,0.0),(0.0,600.0),(600.0,600.0)], (0,255,0),4);
    Ok(())
}
...
fn sierpinski(context: &web_sys::CanvasRenderingContext2d,points: [(f64,f64); 3],color:(u8,u8,u8),depth:u8){
    ...
    if depth > 0 {
        ...
        let next_color = (rng.gen_range(0..255),rng.gen_range(0..255),rng.gen_range(0..255));
